...
<section class="booking-section">
  ...
  if(isset($_POST['book']))
  {
    ...
    $sql = "INSERT INTO `car_booking_list`(`user_name`, `User_email`, `u_mobile`, `Journey`, `Car_type`, `trip_start`, `trip_end`)
     VALUES ('$name','$emali','$phone', '$jour','$car_type','$trip_start','$trip_end')";
